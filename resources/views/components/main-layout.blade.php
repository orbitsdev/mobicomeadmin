                                ...
                                <ul role="list" class="-mx-2 space-y-1">
                                    ...
                                    <li>
                                        ...
                                        class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{
                                         (request()->routeIs('list-students') ||
                                         request()->routeIs('exercise-official-result') ||
                                         
                                         request()->routeIs('student-profile') ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <ul role="list" class="-mx-2 mt-2 space-y-1">
                                    ...
                                    <li>
                                        <a href="{{route('teacher-list-of-enrolled-students')}}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ 
                                            ( request()->routeIs('teacher-list-of-enrolled-students') || request()->routeIs('enrolled-teacher-view-exercise-score')  || 
                                            request()->routeIs('enrolled-view-student') || 
                                            request()->routeIs('exercise-official-result') || 
                                            request()->routeIs('teacher-view-exercise-score')
