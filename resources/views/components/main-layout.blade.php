...
<head>
    ...
    <title>{{ config('app.name', 'Mobicoms') }}</title>
                                ...
                                <ul role="list" class="-mx-2 space-y-1">
                                    <li>
                                        <a href="{{ route('list-users') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ (request()->routeIs('list-users') || request()->routeIs('view-profile') ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                    ...
                                    <li>
                                        <a href="{{ route('list-teachers') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ (request()->routeIs('view-teacher-profile')|| request()->routeIs('list-teachers') || request()->routeIs('manage-teacher-sections') || request()->routeIs('list-teacher-sections') || request()->routeIs('list-teacher-section-students')   ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    <li>
                                        <a href="{{ route('list-sections') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ (request()->routeIs('list-sections')  ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    <li>
                                        ...
                                        class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ (request()->routeIs('list-students') || request()->routeIs('student-profile') ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    <li>
                                        <a href="{{ route('list-excercises') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{
                                             (request()->routeIs('list-excercises') ||
                                              request()->routeIs('manage-excercise-questions') || 
                                              request()->routeIs('create-exercise') || 
                                              request()->routeIs('edit-exercise')  || 
                                                request()->routeIs('manage-multiple-choice') ||  
                                                 request()->routeIs('manage-true-or-false') ||  
                                    ...
                                    <li>
                                        <a href="{{ route('list-of-request-for-removal') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ (request()->routeIs('list-of-request-for-removal') )? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <ul role="list" class="-mx-2 mt-2 space-y-1">
                                    ...
                                    <li>
                                        <a href="{{ route('teacher-list-excercises') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ (request()->routeIs('teacher-list-excercises') ||
                                             request()->routeIs('teacher-manage-excercise-questions') ||
                                              request()->routeIs('teacher-create-exercise') ||
                                              request()->routeIs('teacher-edit-exercise')  || 
                                                request()->routeIs('teacher-manage-multiple-choice') || 
                                                  request()->routeIs('teacher-manage-true-or-false') ||  
                                    ...
                                    <li>
                                        <a href="{{ route('teacher-list-sections') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ ( request()->routeIs('teacher-list-sections') || request()->routeIs('teacher-list-sections-users')  || request()->routeIs('view-student')   ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                                              </svg>
                                    ...
                                    <li>
                                        <a href="{{route('teacher-list-of-enrolled-students')}}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ ( request()->routeIs('teacher-list-of-enrolled-students') || request()->routeIs('enrolled-teacher-view-exercise-score')  || request()->routeIs('enrolled-view-student') || request()->routeIs('teacher-view-exercise-score') ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                                              </svg>
                                              Students
                                    ...
                                    <li>
                                        <a href="{{route('teacher-list-taked-exercises')}}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6  {{ ( request()->routeIs('teacher-list-taked-exercises') ) ? 'selected-higlight ' : 'text-gray-600' }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
