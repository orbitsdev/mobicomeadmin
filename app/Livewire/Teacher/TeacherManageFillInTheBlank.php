...
class TeacherManageFillInTheBlank extends Component implements HasForms
{
                ...
                ->schema([
                    ...
                    TableRepeater::make('exercise_questions')
                        ...
                        ->schema([
                            ...
                            Group::make()
                                ->relationship('fill_in_the_blank')
    ...
    {
        return view('livewire.teacher.teacher-manage-fill-in-the-blank');
    }
}
